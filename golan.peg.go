...
func (p *Parser) Init(options ...func(*Parser) error) error {
	...
	_rules = [...]func() bool{
		...
		/* 12 postfix <- <(primary (_ '(' Action20 sp _ (expression (_ ',' sp _ expression)*)? sp _ <')'> Action21 _)*)> */
		func() bool {
